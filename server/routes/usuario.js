...
const {verificaToken, verificaAdmin} = require('../middlewares/authentication.js');
...
app.get('/usuario', [verificaToken, verificaAdmin]  ,function (req, res) {
    ...
    // query = parametros enviados en la Url
...
app.delete('/usuario/:id', [verificaToken, verificaAdmin], function (req, res) {
    ...
    // Actualiza el estado en lugar de eliminar
